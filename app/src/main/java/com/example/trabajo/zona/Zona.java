...
public class Zona implements Serializable{
    ...
    public int imagen;
    public Zona(String continente, String nombre, float precio, float peso, String
            envio, boolean regalo, boolean dedicatoria, int imagen){
    ...
    public String toString(){
        return "Continente: " + this.continente + ". Zona: " + this.nombre + " Peso: "
                + this.peso
